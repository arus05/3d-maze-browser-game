...
class Renderer {
    ...
    render(maze: Maze, solution: Solution | null = null) {
        ...
        for (const square of maze.squares) {
            ...
            } else if (square.role === Role.EXIT) {
                this.context.fillStyle = "orange"
            } else {
                this.context.fillStyle = "white"
            }

            this.context.fillRect(square.column * this.squareSize + this.offset, square.row * this.squareSize + this.offset, this.squareSize, this.squareSize)
